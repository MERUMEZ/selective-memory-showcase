...
# --------------------------------------------------------------------------
# Список ОБЯЗАН перечислять все модули, где есть связанная ссылка. Он уже
# один раз отстал от кода: коммит 3bee77a унёс evolve_self_model из
# cortex в persona_memory, а сюда его никто не дописал — и стенд с тех
